...
public class HTMLRetriever {
    ...
    public HTMLRetriever(String webPage)
    {
        ...
        try
        {
            ...
            System.out.println("WebUrl Failure. DataScraping.HTMLRetriever Constructor");
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.println("Failure to Establish Connection. DataScraping.HTMLRetriever Constructor");
            e.printStackTrace();
        }
    ...
    public void pullData()
    {
        ...
        try {
            ...
            System.out.println("Read Line Error. scrapeHTML -- DataScraping.HTMLRetriever");
            e.printStackTrace();
        }
